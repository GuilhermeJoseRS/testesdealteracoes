...
!TARS!* 08-04-2014 RALVES  - PROJETO TARIFA SOCIAL                     *
...
!TELE1*!0304!AND AS030-42-CD-APLICACAO = 180)
!0304!      AND  AS030-43-CD-APLICACAO = 180)
!TELE1
...
!SIGA!
!SIGA2          MOVE               1            TO WS-EMISS-CARTAO
!SIGA2
!SIGA2          IF  WS-APLIC-SCONT EQUAL 210 OR 220
!SIGA2
!SIGA2              INITIALIZE SBE-CC-CARTAO-SCON
!SIGA2
!SIGA2              MOVE AS030-TX-NR-CHIP-CARTAO
!SIGA2                TO NR-CHIP-CARTAO-SC         OF SBE-CC-CARTAO-SCON
!SIGA2
!SIGA2              PERFORM   82000-SELECT-CCCARSCO
!SIGA2          END-IF

!SIGA!          PERFORM   84000-VERIFICA-RESSAR

!SIGA!          IF WS-RESSAR-NOK
...
!TARS!             ELSE
!TARS!                IF AS030-11-TP-DEBITO = 7
!TARS!                   ADD AS030-11C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
!FIPU!             END-IF
!2012!          END-IF
!2012!       END-IF
...
!FIPU!                ADD 1   TO W81-VFILI-QT-PU-REALIZADO  (W81-IFILI)
!TARS!             ELSE
!TARS!                IF AS030-31-TP-DEBITO = 7
!TARS!                   ADD AS030-31C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
...
!FIPU!                ADD 1   TO W81-VFILI-QT-PU-REALIZADO  (W81-IFILI)
!TARS!             ELSE
!TARS!                IF AS030-12-TP-DEBITO = 7
!TARS!                   ADD AS030-12C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
...
!FIPU!                ADD 1   TO W81-VFILI-QT-PU-REALIZADO  (W81-IFILI)
!TARS!             ELSE
!TARS!                IF AS030-32-TP-DEBITO = 7
!TARS!                   ADD AS030-32C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
...
!FIPU!                ADD 1   TO W81-VFILI-QT-PU-REALIZADO  (W81-IFILI)
!TARS!             ELSE
!TARS!                IF AS030-13-TP-DEBITO = 7
!TARS!                   ADD AS030-13C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
...
!FIPU!                ADD 1   TO W81-VFILI-QT-PU-REALIZADO  (W81-IFILI)
!TARS!             ELSE
!TARS!                IF AS030-33-TP-DEBITO = 7
!TARS!                   ADD AS030-33C-VL-TRANS
!TARS!                    TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARS!                   ADD 1
!TARS!                    TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARS!                END-IF
...
!2405!                  ADD 1 TO W81-VFILI-QT-BUCS-REALIZADO (W81-IFILI)
!FIPU!                ELSE
...
!TARSP                        ADD AS030-14C-VL-TARIFA-INTEGRACAO
!TARSP                         TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARSP                        ADD 1
!TARSP                         TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARSP                      END-IF
!FIPU!                   END-IF
!2405!                END-IF
!2012!             END-IF
...
!TARSP                        ADD AS030-34C-VL-TARIFA-INTEGRACAO
!TARSP                         TO W81-VFILI-VL-BUA-REALIZADO (W81-IFILI)
!TARSP                        ADD 1
!TARSP                         TO W81-VFILI-QT-BUA-REALIZADO (W81-IFILI)
!TARSP                      END-IF
